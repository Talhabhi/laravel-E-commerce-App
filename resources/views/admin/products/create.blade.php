                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" id="summernote" cols="30" rows="10" class="summernote" placeholder="Description"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="col-md-3"> <div class="card" style="">
                <img src="${response.imagePath}" class="card-img-top" alt="">
                <div class="card-body"><a href="javascript:void(0)" onclick="deleteImage(${response.image_id})" class="btn btn-danger">Delete</a>
                </div>
                </div> </div>`
